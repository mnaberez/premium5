...
A firmware binary is required.  One can be built, byte-for-byte identical to the original, from [this disassembly](https://github.com/mnaberez/vwradio/tree/main/reverse_engineering/delco/vw_premium_5/disasm).
